...
var getRoot = function () { return Optional.from(document.getElementById('root')).getOrThunk(function () {
    var root = document.createElement('div');
    root.id = 'root';
    document.body.appendChild(root);
    return root;
}); };
var cRender = function (props) { return Chain.async(function (_, next, die) {
...
var cReRender = function (props) { return Chain.op(function (context) {
    ReactDOM.render(React.createElement("div", null,
...
var cDOMNode = function (chain) { return NamedChain.asChain([
    cNamedChainDirect('DOMNode'),
    NamedChain.read('DOMNode', chain),
    NamedChain.outputInput
]); };
var cEditor = function (chain) { return NamedChain.asChain([
