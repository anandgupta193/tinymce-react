...
var getRoot = function () { return katamari_1.Optional.from(document.getElementById('root')).getOrThunk(function () {
    var root = document.createElement('div');
    root.id = 'root';
    document.body.appendChild(root);
    return root;
}); };
var cRender = function (props) { return agar_1.Chain.async(function (_, next, die) {
...
var cReRender = function (props) { return agar_1.Chain.op(function (context) {
    ReactDOM.render(React.createElement("div", null,
...
var cDOMNode = function (chain) { return agar_1.NamedChain.asChain([
    cNamedChainDirect('DOMNode'),
    agar_1.NamedChain.read('DOMNode', chain),
    agar_1.NamedChain.outputInput
]); };
exports.cDOMNode = cDOMNode;
var cEditor = function (chain) { return agar_1.NamedChain.asChain([
